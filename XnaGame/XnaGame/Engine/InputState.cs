...
namespace XnaGame
{
    ...
    public class InputState
    {
        ...
        /// <summary>
        /// Easy method to check if a gamepad disconnected this frame.
        /// </summary>
        /// <param name="controllingPlayer"></param>
        /// <returns></returns>
        public bool GamepadDisconnected(PlayerIndex? controllingPlayer)
        {
            int i = (int)controllingPlayer.Value;
            return !CurrentGamePadStates[i].IsConnected && GamePadWasConnected[i];
        }
